<template>
    <header class="header">
        <div class="container">
            <a href="index.html"><svg width="100" viewBox="0 0 675 312" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="nav nav_big_screen">
                <a href="products.html">ТОВАРЫ</a>
                <a href="#" class="header_search">ПОИСК</a>
                <a href="basket.html">КОРЗИНА</a>
                <a href="about.html">О НАС</a>
            </div>
    
            <div class="nav nav_big_screen">
                <a href="login.html" class="no_auth_user">ВОЙТИ</a>
                <a href="register.html" class="no_auth_user">РЕГИСТРАЦИЯ</a>
            </div>
    
            <div class="menu_btn main">
                <span></span>
                <span></span>
                <span></span>
            </div>
